...
| `profile/artifacts/github-dashboard/snapshot.json` | `github-dashboard` | `tools/modules/github_dashboard.py` |
| `profile/artifacts/github-dashboard/metadata.json` | `github-dashboard` | `tools/modules/github_dashboard.py` |
| `profile/artifacts/github-dashboard/card-*.svg` | `github-dashboard` | `tools/modules/github_dashboard.py` |
